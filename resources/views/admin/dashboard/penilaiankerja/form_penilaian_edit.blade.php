      ...
      <div class="col-12 mx-auto"> 
        <div class="card">
         <div class="card-body">
          ...
          <form data-route="{{ Route('UpdateJawaban') }}"  data-routeback="#" id="myForm" role="form" method="POST" data-toggle="validator" accept-charset="utf-8">
          @csrf

          <!-- SmartWizard html -->
          <div id="smartwizard">
            <h3> Edit Form Penilaian Kerja</h3>
          ...
          @php 
          $cek_data = DB::table('b_jawaban')
                    ->join('b_soal','b_soal.id_soal','=','b_jawaban.id_soal')
                    ->select('b_jawaban.*','b_soal.kategori_soal','b_soal.id_soal')
                    ->where([['b_jawaban.id_user','=',$id_user],['b_soal.id_soal','=',$showsoal->id_soal]])
                    ->first();
            ...
            <div id="step-{{ $no }}"  role="form">
              <div id="form-step-{{$no2}}" role="form" data-toggle="validator" class="row">
                <div class="form-group col-md-12">
                  ...
                  <input type="hidden" name="id_jawaban{{$key}}" value="{{ $cek_data->id_jawaban}}">
                  ...
                  <table class="table table-hover" width="100%">
                    ...
                    <td>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary{{$no + 100}}" value="a" name="jawaban{{$key}}" required="" @if($cek_data->jawaban == 'a') checked="" @endif>
                    ...
                    <td>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary{{$no + 200}}" value="b" name="jawaban{{$key}}" required=""  @if($cek_data->jawaban == 'b') checked="" @endif>
                    ...
                    <td>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary{{$no + 300}}" value="c" name="jawaban{{$key}}" required=""  @if($cek_data->jawaban == 'c') checked="" @endif>
                    ...
                    <td>
                      <div class="icheck-primary d-inline">
                        <input type="radio" id="radioPrimary{{$no + 400}}" value="d" name="jawaban{{$key}}" required=""  @if($cek_data->jawaban == 'd') checked="" @endif>
