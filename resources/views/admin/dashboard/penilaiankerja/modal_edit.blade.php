         ...
         <h5>Data Diri Umum :</h5>
          <div class="card-body row" style="padding: 1px;">
                    ...
                    <div class="col-md-3">
                      ...
                      <label>Nomor KTP :</label>
                       <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="nomor_ktp" id="nomor_ktp" required onkeypress="return isNumberKey(event)" maxlength="20">
                    ...
                    <div class="col-md-3">
                      ...
                      <label>Nomor NPWP :</label>
                       <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="nomor_npwp" id="nomor_npwp" onkeypress="return isNumberKey(event)" maxlength="30">
                       ...
                       <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <select class="form-control select " id="kabupatenkota" name="kota_lahir" required >
                                <option value="{{ $Ddiri->kota_lahir }}">{{ $Ddiri->dis_name }}</option>
                            </select>
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                        <label>Alamat Sekarang : <code>(Domisili)</code></label>
                          ...
                          <label for="kecamatan_domisili">Kecamatan : <code>(Domisili)</code></label>
                            <div class="input-group">
                              ...
                              <select  class="form-control kecamatan_domisili" id="kecamatan_domisili" name="kecamatan_domisili" required="">
                                  ...
                                  <option @if($item_kec_domisili->dis_id == $Ddiri->kecamatan_domisili) selected @endif value="{{$item_kec_domisili->dis_id}}">{{$item_kec_domisili->dis_name}}</option>                                        
                                  @endforeach
                              </select >
                          ...
                          <label for="kelurahan_domisili">Kelurahan : <code>(Domisili)</code></label>
                            <div class="input-group">
                              ...
                              <select  class="form-control KelurahanDomisili" id="KelurahanDomisili" name="KelurahanDomisili" required="">
                                  <option value="{{ $Ddiri->kelurahan_domisili }}">{{ $Ddiri->subdis_name }}</option>
                              </select >
                  ...
                  <div class="form-group col-md-1">
                      <div class="row">
                        <div class="col-md-12">
                          <label for="rt_domisili">RT : <code>(Dom)</code></label>
                            <div class="input-group">
                              <input type="text" class="form-control" name="rt_domisili" value="{{ $Ddiri->rt_domisili }}" placeholder="003" onkeypress="return isNumberKey(event)" maxlength="10">
                  ...
                  <div class="form-group col-md-1">
                      <div class="row">
                        <div class="col-md-12">
                          <label for="rw _domisili">RW : <code>(Dom)</code></label>
                            <div class="input-group">
                              <input type="text" class="form-control" name="rw_domisili" value="{{ $Ddiri->rw_domisili }}" placeholder="005" onkeypress="return isNumberKey(event)" maxlength="10">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        ...
                        <table border="0" class="table table-sm table-bordered" width="100%">
                            <tr>
                              <thead class="bg-info">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-2" >
                      <div class="row">
                          <div class="col-md-12" id="showikrartahun">
                            <label for="Suku">Ikrar Tahun :</label>
                            <div class="input-group">
                            <div class="input-group-prepend">
                              <span class="input-group-text"><i class="fa fa-user"></i></span>
                            </div>
                    ...
                    <div class="form-group col-md-4">
                      <div class="row">
                          <div class="col-md-12" >
                          <label for="status">Status Di Vihara </label>
                     ...
                     <div class="form-group col-md-3">
                        <div class="row">
                            <div class="col-md-12">
                            <label for="status">Detail Status Di Vihara </label>
...
<font style="color: #007bff" size="2px">*Khusus Umat Maitreya, Jika Sudah <b>Qiu Dao</b></font>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      ...
      <div class="modal-header bg-info">
        ...
        <form data-route="{{ Route('EditIdentitas') }}" id="UpdateIdentitas" role="form" data-toggle="validator" method="POST" accept-charset="utf-8">
        {{ csrf_field() }}
...
<div id="jabatan_tam" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header bg-info">
        <h3 class="modal-title">Tambah Jabatan Lainnya </h3>

        <button type="button" class="close" data-dismiss="modal">&times;</button> 
        </div>

        <form action="{{ Route('TambahJabatan') }}" role="form"  method="POST" accept-charset="utf-8">
        @csrf
        ...
        <div class="modal-body mx-auto">
            <div class="card-body row" style="padding: 1px;">
              ...
              <div class="form-group col-md-6">
                      <div class="row">
                        <div class="col-md-12">
                          <label for="Jabatan Pendidik">Pilih Jabatan :</label>
                            <div class="input-group">
                              <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-address-card"></i></span>
                              </div>
                              <select class="form-control select" id="jabatan_pendidik" name="jabatanbaru" required >
                                <option value="" >------Pilih Bagian-----</option>
                                  @foreach ($jabatanlist as $jabatanlistitem)
                                  <option value="{{$jabatanlistitem->id_set_jabatan}}">{{$jabatanlistitem->nama_jabatan}}</option>                                        
                                  @endforeach
                              </select>
                            </div>
                            <font style="color: #007bff" size="2px">*Wajib diisi</font>
                  ...
                  <div class="form-group col-md-6">
                    <div class="row">
                        <div class="col-md-12">
                          <label for="subjabatanpendidik">Sub Jabatan :</label>
                            <div class="input-group">
                              <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-address-card"></i></span>
                              </div>
                              <select id="subjabatanpendidik" name="sub_jabatanbaru" class="form-control select" required  >
...
<div id="jabatan_akademik" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
       <div id="overlayiden">
      ...
      <div class="modal-header bg-info">
        <h3 class="modal-title">Serdos dan Jabatan Akademik</h3>

        <button type="button" class="close" data-dismiss="modal">&times;</button> 
        </div>

        <form action="{{ Route('TambahJabatanAka') }}" role="form"  method="POST" accept-charset="utf-8">
        @csrf
        ...
        <div class="modal-body mx-auto">
            <div class="card-body row" style="padding: 1px;">
                        ...
                        <div class="col-md-12">
                          <label for="Jabatan Pendidik">Pilih Jabatan :</label>
                            <div class="input-group">
                              ...
                              <select class="form-control select" name="jabatanakademik" required >
                                <option value="" >------Pilih Bagian-----</option>
                                  @foreach ($jab_aka as $jab_akashow)
                                  <option value="{{$jab_akashow->id_jabatan_akademik}}">{{$jab_akashow->nama_jab_akademik}}</option>                                        
                                  @endforeach
                              </select>
                            </div>
                            <font style="color: #007bff" size="2px">*Wajib diisi</font>
              ...
              <table border="0" class="table table-sm table-bordered">
                  <tr>
                    <thead class="bg-info">
                      <th colspan="5"><center>Status Serdos</center></th>
                    </thead>
                    <tbody>
                      <td>
                        <div class="icheck-success d-inline">
                          <input type="radio" id="radioPrimary100" value="Sudah" name="serdos" required="" onclick="javascript:houseclean123();">
                          <label for="radioPrimary100">
                            Sudah
                          </label>
                        </div>
                      </td>

                      <td id="nomor_serdos_td" style="display: none;">
                          <input type="text" id="nomor_serdos" class="form-control" name="nomor_regis" placeholder="Isi Nomor Registrasi" disabled="" required="">
                          <div class="help-block with-errors text-danger"></div>
                      </td>
                      <td>
                        <div class="icheck-warning d-inline">
                          <input type="radio" id="radioPrimary111" value="Proses" name="serdos" required="" onclick="javascript:houseclean123();">
                      ...
                      <td>
                        <div class="icheck-danger d-inline">
                          <input type="radio" id="radioPrimary101" value="Belum" name="serdos" required="" onclick="javascript:houseclean123();">
                          <label for="radioPrimary101">
                            Belum
                          </label>
                        </div>
                      </td>
                      <script type="text/javascript">
                         ...
                         function houseclean123()
                          {
                          if (document.getElementById('radioPrimary100').checked == true)
                            {
                            //$("#nomor_serdos_td").show(500);
                            document.getElementById('nomor_serdos_td').removeAttribute('style');
                            ...
                            document.getElementById('nomor_serdos_td').style.display = 'none';
                            }
                          }
                      </script>
                    </tbody>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary">Tambah Serdos</button>
      </div>
      </form>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-header bg-info">
        ...
        <form action="{{ Route('TambahPerting') }}" role="form"  method="post" accept-charset="utf-8">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control"  name="nomor_telepon_pasangan" required="" id="nomor_telepon_pasangan2"  placeholder="Masukan Nomor Telepon Suami Atau Istri" data-inputmask='"mask": "9999-9999-9999"' data-mask />
                      </div>
                      <div class="help-block with-errors text-danger"></div>
                      </div>
                  </div>
...
<div id="TambahPasanganMarital" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-info">
                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group">
                        ...
                        <input class="form-control"  name="nomor_telepon_pasangan" required=""  placeholder="Masukan Nomor Telepon Suami Atau Istri" data-inputmask='"mask": "9999-9999-9999"' data-mask />
                      </div>
                      <div class="help-block with-errors text-danger"></div>
                      </div>
                  </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-info">
        ...
        <form action="{{ Route('TambahAnakMarital') }}" role="form"  method="POST" accept-charset="utf-8">
        @csrf
                  ...
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="input-group-prepend">
                          ...
                          <input class="form-control" name="nomor_darurat" required="" id="nomor_darurat" placeholder="Masukan Nomor Telepon" data-inputmask='"mask": "9999-9999-9999"' data-mask/>
                        </div>
                        <font style="color: #007bff" size="2px">*Wajib diisi</font>
                        <div class="help-block with-errors text-danger"></div>
                        </div>
