...
<p style="margin: 0in 0in 0.0001pt; text-align: center; font-size: 12pt; font-family: 'Times New Roman', serif; font-weight: bold;"><span style="font-size: 14.0pt; font-family: Arial, sans-serif;">Daftar Hadir Mahasiswa Seminar
</span><span style="font-size: 14.0pt; font-family: Arial, sans-serif;"> </span></p>
...
<table class="MsoTableGrid" style="width: 567.05pt; margin-left: -27.15pt; border-collapse: collapse; border: none; height: 48px;" border="1" cellspacing="0" cellpadding="0">
<tbody>
...
<td style="width: 21.0669%;"><span style="font-size: 11.0pt; font-family: Arial, sans-serif;">Pukul</span></td>
<td style="width: 1.16822%;">:</td>
<td style="width: 77.7648%;font-size: 11.0pt; font-family: Arial, sans-serif;">
	@if($cek->jam_mulai == $cek->jam_selesai){{cek_jam($cek->jam_mulai)}} WIB s/d Selesai
	@else
		{{cek_jam($cek->jam_mulai)}} - {{cek_jam($cek->jam_selesai)}} WIB
	@endif
