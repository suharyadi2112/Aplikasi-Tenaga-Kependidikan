...
<body onload="window.print()" style="margin-top: 70px; margin-left:50px; margin-right: 50px;">
...
<table class="MsoNormalTable" style="width: 470.9pt; margin-left: 4.65pt; border-collapse: collapse;" border="0" cellspacing="0" cellpadding="0">
<tbody>
