...
<td style="width: 79.1666%; height: 21px; font-size: 11.0pt;"><b>{{ $cek->nama }}</b></td>
</tr>
<tr style="height: 21px;">
<td style="width: 19.6651%; height: 21px; font-size: 11.0pt;">NIM</td>
<td style="width: 1.16822%; height: 21px; font-size: 11.0pt;">:</td>
<td style="width: 79.1666%; height: 21px; font-size: 11.0pt;"><b>{{ $cek->nim }}</b></td>
</tr>
<tr style="height: 21px;">
...
<td style="width: 1.16822%; height: 21px; font-size: 11.0pt;">:</td>
<td style="width: 79.1666%; height: 21px; font-size: 11.0pt;"><b>{{cek_hari($date)}}</b></td>
</tr>
<tr style="height: 21px;">
<td style="width: 19.6651%; height: 21px; font-size: 11.0pt;">Tanggal</td>
<td style="width: 1.16822%; height: 21px; font-size: 11.0pt;">:</td>
<td style="width: 79.1666%; height: 21px; font-size: 11.0pt;"><b>{{tanggal_indo($cek->tanggal_pelaksanaan)}}</b></td>
</tr>
<tr style="height: 21px;">
<td style="width: 19.6651%; height: 21px;font-size: 11.0pt;">Jam</td>
<td style="width: 1.16822%; height: 21px;font-size: 11.0pt;">:</td>
<td style="width: 79.1666%; height: 21px; font-size: 11.0pt;"><b>
