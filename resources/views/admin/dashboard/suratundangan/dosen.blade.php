...
<div class="container-fluid"> 
    <div class="row">
      <div class="col-12">
        ...
        <font size="1">*Dosen penguji surat undangan berhubungan dengan dosen penguji di <b>SURAT TUGAS PENGUJI</b></font>
        ...
        <div class="card card-info">
          <div class="card-header">
            <a href="#" class="tambahdosen btn btn-sm" data-id="{{$id_undangan}}" style="float: right; background: #08203c">
              <span class="fa fa-plus"> </span> Tambah Dosen Penguji
            </a>
            <h3 class="card-title">Surat Undangan/Surat Tugas Penguji (Dosen Penguji)</h3>
          </div>
          ...
          <div class="card-body">
            ...
            <a href="{{{ route('indexundangan') }}}" title="Kembali"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Surat Undangan</a> | 
            <a href="{{{ route('IndexSuratTugasPembimbing') }}}" title="Kembali"><i class="fa fa-arrow-circle-left"></i> Kembali Ke Surat Tugas</a>
          </div>
          <!-- /.card-body -->
        </div>
        <!-- /.card -->
          ...
          <div class="modal-content">
            <div id="overlay">
              ...
              <div class="modal-header bg-info">
                  <h3 class="modal-title">Tambah Dosen Penguji</h3>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body">
                      ...
                      <input type="hidden" name="kategori_dosen" id="#" value="Penguji"/>
